...
# 3) Agregar fn y calcular las derivadas ----
# Funcion 1 y sus derivadas ----
f1 <- function(x1,x2){
  return(3* x1^2 - x2^2)
}

f<-expression(3*x1^2 - x2^2)
fprima<-D(f,"x2")
fprima
...
# 4) Defino como será la Matriz jacobiana----
...
# 5) Elegimos los puntos donde se evaluan la fn y el jacobiano ----
x <- c(0.1,0.1)
n=2
